                    ...
                    <div class="card-body bg-white">
                        ...
                        <form action="{{ route('peminjaman.store') }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" required name="tanggal_pengembalian" id="tanggal_pengembalian" class="form-control" value="{{ \Carbon\Carbon::parse(date('Y-m-d'))->addWeeks()->format('Y-m-d') }}">
                            </div>
